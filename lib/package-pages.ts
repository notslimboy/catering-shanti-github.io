export const PACKAGE_PAGES = {
  "catering-pernikahan-surabaya": {
    ...
    summary: "Susun hidangan resepsi yang sesuai jumlah tamu dan konsep acara Anda.",
    image: "/images/tumpeng.jpg",
    highlights: ["Pilihan prasmanan", "Menu pendamping", "Konsultasi kebutuhan acara"],
  },
  "catering-kantor-surabaya": {
    ...
    highlights: ["Nasi kotak", "Coffee break", "Konsultasi jadwal pengiriman"],
  },
  "catering-aqiqah-surabaya": {
    ...
    highlights: ["Paket keluarga", "Pilihan nasi box", "Konsultasi jumlah porsi"],
  },
  "nasi-kotak-surabaya": {
  ...
  "tumpeng-surabaya": {
    ...
    image: "/images/tumpeng.jpg",
    highlights: ["Tumpeng untuk perayaan", "Menu pendamping", "Konsultasi kebutuhan acara"],
  },
} as const;
